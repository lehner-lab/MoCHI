...
def init_argparse(
    ...
    parser.add_argument('--downsample_observations', help = "number (if integer) or proportion (if float) of observations to retain including WT (default: no downsampling)")
    parser.add_argument('--downsample_interactions', help = "number (if integer) or proportion (if float) of interaction terms to retain (default: no downsampling)")
