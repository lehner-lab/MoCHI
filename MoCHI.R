...
option_list <- list(
  ...
  optparse::make_option(opt_str=c("--adjustmentMethod"), type="double", default=0.1, help = "Method for adjusting P-values for multiple comparisons; any method in p.adjust.methods is permitted (default:'fdr')"),
